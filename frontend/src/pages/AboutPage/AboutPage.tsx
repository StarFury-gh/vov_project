    ...
    return (
        <div className={styles['about-page']}>
            ...
            <section className={styles['about-page__section']}>
                ...
                <p>
                    Проект [Название] создан для того, чтобы объединить два величайших эпопеи в истории нашей страны: Великую Отечественную войну и Специальную военную операцию. Мы видим прямую преемственность: солдат Победы 1945 года и боец СВО — это звенья одной цепи, защитники одного Отечества.
                </p>
                <label>
